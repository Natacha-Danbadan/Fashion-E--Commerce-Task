  ...
  return (
    <>
      <div className='pr-16 pl-16 bg-founders'>
        ...
        <div className='pb-20 md:flex md:flex-row md:justify-evenly lg:justify-between md:flex-wrap'>
          <div>
            <div>
      ...
      <div className='bg-testimonialSection h-full w-full'>
        ...
        <div className='xs:flex xs:flex-col xs:items-center sm:flex sm:flex-col sm:items-center md:flex md:flex-row lg:flex lg:flex-row '> 
          <div className='w-40 h-40 lg:ml-56 lg:mt-24 md:ml-24 md:mt-24 sm:mt-16 xs:mt-16  testimonial-image'>
          ...
          <div className=' lg:mr-24 lg:w-[663px] lg:h-[102px] md:w-[663px] md:h-[51px] md:pb-36 md:mr-8 sm:w-[500px] sm:pb-36 sm:h-[51px] xs:pr-12 xs:pl-12  testimonial-text'>
            ...
            <p className='text-testimonialText font-lato font-normal text-xl pb-8 '>Once we ordered some accessories items and we got the products delivered in our doorstep, the customer support was super helpful and they answered all my queries.</p>
        ...
        <div className='xs:flex xs:flex-col xs:items-center sm:flex sm:flex-col sm:items-center md:flex md:flex-row lg:flex lg:flex-row '> 
          ...
          <div className=' lg:mr-24 lg:w-[663px] lg:h-[102px] md:w-[663px] md:h-[51px] md:pb-36 md:mr-8 sm:w-[500px] sm:pb-36 sm:h-[51px] xs:pr-12 xs:pl-12  testimonial-text'>
            <RiDoubleQuotesL className='w-9 h-7 mb-6 '/>
            <p className='text-testimonialText font-lato font-normal text-xl pb-8 '>I ordered 5 shirts from them and received them in no time. The customer support was awesome!</p>
            <h3 className='text-testifierName font-bold text-xl font-arimo'>Tiffany</h3>
          </div>
        </div>

        <div className='md:pb-16 sm:pb-24 xs:flex xs:flex-col xs:items-center sm:flex sm:flex-col sm:items-center md:flex md:flex-row lg:flex lg:flex-row '> 
          <div className='w-40 h-40 lg:ml-56 lg:mt-24 md:ml-24 md:mt-24 sm:mt-16 xs:mt-16  testimonial-image'>
            <img className='w-full h-full' src={testifier3} alt={"testifier"} />
          </div>
          <div className=' lg:mr-24 lg:w-[663px] lg:h-[102px] md:w-[663px] md:h-[51px] md:pb-36 md:mr-8 sm:w-[500px] sm:pb-36 sm:h-[51px] xs:pr-12 xs:pl-12  testimonial-text'>
            <RiDoubleQuotesL className='w-9 h-7 mb-6 '/>
            <p className='text-testimonialText font-lato font-normal text-xl pb-8 '>I got a wrong shirt so I contacted them and they happily offered me a refund. I will surely shop from them again.</p>
            <h3 className='text-testifierName font-bold text-xl font-arimo pb-6'>James</h3>
          </div>
        </div>
      </div>
  </>
