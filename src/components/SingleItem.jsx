...
function SingleItem({product}) {
  ...
  return (
    <div>
      <div className="border border-[#e4e4e4] h-[342px] w-[295px] mb-4 relative overflow-hidden group transition">
      ...
      <div>
        <div className='flex justfy-center'>
          <Link to = {`/product/${id}`}>
            <h2 className='font-semibold text-center mb-1 font-arimo lg:mx-auto'>{title}</h2>
          </Link>
        </div>
        <div className="font-semibold text-center text-active font-lato">${price}</div>
      </div>
    </div>
